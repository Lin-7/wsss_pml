...
from tool.RoiPooling_Jointly import RoiPooling, RoiPooling1
...
class Net(network.resnet38d.Net):
    ...
    def patch_based_metric_loss(self, img, x_patch, label, bboxes, bbxs_cls, bbxs_img, patch_nums=[4], is_same_img=False, is_hard_negative=True, epoch_iter="null", img_names=[], args=""):
        ...
        if len(roi_cls_feature_vector) == 0:
            ...
            selected_ratio = 0.3
            As = proposal_num * 4 * selected_ratio
            Ag = len(patch_labels)
            ...
            if select_part == 0:
                ...
                raise ValueError(f"'select_part' must be 0, 1, 2 or 3. But now 'select_part' is {select_part}!!!!")
